"""
Django settings for denisshopsite project.
...
SECRET_KEY = 'django-insecure-v!#5n8tq@7e(6$e*@*h#qmhe8b2g5d+pofx-q^&&a9fdt7j5p='
...
ROOT_URLCONF = 'denisshopsite.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'denisshop.context_processors.get_menu'
            ],
        },
    },
]

WSGI_APPLICATION = 'denisshopsite.wsgi.application'
